...
![Cung-Cầu dịch chuyển](images/01_supply_demand_shift.png)
...
![Hàng thay thế vs bổ sung](images/02_substitute_complement.png)
...
![MR = MC](images/03_mc_decision.png)
...
![Chuyển đổi cấu trúc](images/05_market_structure.png)
...
| **Câu 3** | MR=MC: Giảm sản lượng, tăng giá vừa phải                  |
